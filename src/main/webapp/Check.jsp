                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-8">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <h1 class="text-primary">Risk's Check</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-light text-center rounded p-4">
                    <div class="table-responsive">
                        <div class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <p style="overflow-wrap: normal">The Check about: <br> <%=sub%> <%=pred%> <%=obj%> is TRUE</p>
                            <%}else{%>
                            <p style="overflow-wrap: normal">The Check about: <br> <%=sub%> <%=pred%> <%=obj%> is FALSE</p>
                            <%}%>
                        </div>
                    </div>
                    <br>
